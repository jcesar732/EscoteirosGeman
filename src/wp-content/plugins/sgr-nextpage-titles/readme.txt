...
Tags: multipage, multi-page, nextpage, subpages, seo, posts, page, index, table-of-contents, shortcode
...
2. Activate the Multipage Plugin through the 'Plugins' menu in WordPress
...
1. Here you can see how to use Multipage shortcodes. It's very simple.
2. A sample page using Multipage plugin.
3. The configuration page placed under "Settings > Multipage".

== Changelog ==

= 1.3.7 =
Release Date: July, 3nd, 2017
